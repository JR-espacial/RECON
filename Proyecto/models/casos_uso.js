...
module.exports =  class Casos_Uso{
    ...
    static fetchQuiero (idIteracion) {
        return db.execute('SELECT id_casos, id_iteracion, numero_cu, quiero, real_minutos, porcentaje_avance FROM casos_uso WHERE id_iteracion=? ORDER BY id_casos DESC;', 
        [idIteracion]);
    }
